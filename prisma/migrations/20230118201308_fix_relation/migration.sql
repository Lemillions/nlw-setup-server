/*
  ...
  - You are about to drop the column `dayId` on the `days_habit` table. All the data in the column will be lost.
  - You are about to drop the column `habitId` on the `days_habit` table. All the data in the column will be lost.
